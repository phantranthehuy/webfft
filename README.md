...
| Tab | Mô tả ngắn |
|-----|------------|
| **Simulator** | Mô phỏng DFT từng bước, sơ đồ **bước bướm FFT** (butterfly) tương tác; công thức hiển thị bằng KaTeX. |
| **Analyzer** | **Phân tích phổ** và **spectrogram** thời gian thực từ micro (STFT + FFT). |
